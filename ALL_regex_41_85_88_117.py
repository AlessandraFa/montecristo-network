regex_dict_41_85_88_117 = {r"(?<!Louis\s)(?<!old\s)\b(Edmond\s+)?\b(?<!\w)(Dant[èe]s|Edmond|\b(The\s)?\b([Cc]ount\sof\s)?Monte\sCristo|Count\s+Monte\s+Cristo|Sinbad\b(\sthe\s[sS]ailor)?|\b([Ll]ord\s)?Wilmore|\b([Aa]bb[ée]\s)?Busoni|Zatarra|Maltese)(?!\w)": "EdmondDantes", # all + add|(?<!\w)Abb[ée](?!\sFaria) for chapters 21-40 __1__2__3__4__5__6__7__8
 ...
 r"(Ali(?!\sPasha)\b(\sTebelen)?|\sthe\sNubian)(?!\w)": "Ali", # all except 1-20 __2__3__4__5__6__7__8
 ...
 r"(?<!M.\s)(?<!Julie\s)(?<!old\s)\b(Maximilian\s)?(?<!\w)Morrel(?!\w)|(?<!\w)Maximilian(?!\w)": "MaximilianMorrel", # start from chapter 41 __3__4__5__6__7__8
 ...
 r"(?<!Maximilian\s)(?<!Julie\s)\b(old\s)+Morrel(?!\w)": "MonsieurMorrel", # valid until chapter 41, then "(?<!Maximilian\s|Julie\s)\b(old\s)+Morrel(?!\w)" (only 1 match) __1__2__3__4__5__6__7__8
