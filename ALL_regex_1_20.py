regex_dict_1_20 = {r"(?<!Louis\s)(?<!old\s)\b(Edmond\s+)?\b(?<!\w)(Dant[èe]s|Edmond|\b(The\s)?\b([Cc]ount\sof\s)?Monte\sCristo|Count\s+Monte\s+Cristo|Sinbad\b(\sthe\s[sS]ailor)?|\b([Ll]ord\s)?Wilmore|\b([Aa]bb[ée]\s)?Busoni|Zatarra|Maltese)(?!\w)": "EdmondDantes", # all + add|(?<!\w)Abb[ée](?!\sFaria) for chapters 21-40 __1__2__3__4__5__6__7__8
